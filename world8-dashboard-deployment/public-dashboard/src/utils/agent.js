...
// Use local canister IDs as fallbacks
const PAYOUT_CANISTER_ID = process.env.REACT_APP_PAYOUT_CANISTER_ID || "br5f7-7uaaa-aaaaa-qaaca-cai";
const WALLET_CANISTER_ID = process.env.REACT_APP_WALLET_CANISTER_ID || "bkyz2-fmaaa-aaaaa-qaaaq-cai";
// Use local replica host as fallback
const IC_HOST = process.env.REACT_APP_IC_HOST || "http://127.0.0.1:8000";
const API_REQUEST_TIMEOUT = parseInt(process.env.REACT_APP_API_REQUEST_TIMEOUT) || 30000;

// Flag to use mock data instead of actual canisters - SET TO FALSE for local testing
